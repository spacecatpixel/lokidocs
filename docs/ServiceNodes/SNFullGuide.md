title: Loki Documentation | Loki Service Node Full Guide
...
>> Please note the loki-launcher is no longer being worked on. Please see the [Debian Package Guide](DebianPackageGuide.md).

...
This is a list of the RPC calls, their inputs and outputs, and examples of each. This list is autogenerated and was last generated on: 2019-07-23
 ...
 * `checkpoints - checkpoint_serialized[]`: Array of requested checkpoints
   ...
   * `height - uint64`
   * `block_hash - string`
   * `signatures - voter_to_signature_serialized[]`
     * `voter_index - uint16`
     * `signature - string`
   * `prev_height - uint64`
 * `status - string`: Generic RPC error code. "OK" is the success value.

...
curl -X POST http://127.0.0.1:22023/json_rpc -d '
{
  "jsonrpc":"2.0", "id":"0", "method":"get_service_node_key",
  "params": {
    "request": [{
...
curl -X POST http://127.0.0.1:22023/json_rpc -d '
{
  "jsonrpc":"2.0", "id":"0", "method":"perform_blockchain_test",
  "params": {
    "max_height": 123,
    "seed": 123
  }
...
curl -X POST http://127.0.0.1:22023/json_rpc -d '
{
  "jsonrpc":"2.0", "id":"0", "method":"get_service_node_blacklisted_key_images",
  "params": {
    "request": [{
...
Example Request
curl -X POST http://127.0.0.1:22023/get_output_blacklist.bin -d '
{
  "request": [{
...
curl -X POST http://127.0.0.1:22023/json_rpc -d '
{
  "jsonrpc":"2.0", "id":"0", "method":"get_checkpoints",
  "params": {
    "request": [{
        "start_height": 123,
        "end_height": 123,
...
curl -X POST http://127.0.0.1:22023/json_rpc -d '
{
  "jsonrpc":"2.0", "id":"0", "method":"get_service_nodes_state_changes",
  "params": {
    "request": [{
        "start_height": 123,
        "end_height": 123

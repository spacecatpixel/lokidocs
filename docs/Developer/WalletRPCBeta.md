...
description: This is a list of the loki-wallet-rpc calls, their inputs and outputs, and examples of each which are automatically updated. The program loki-wallet-rpc replaced the rpc interface that was in the Monero simplewallet and then loki-wallet-cli.

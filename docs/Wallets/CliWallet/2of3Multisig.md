title: Loki Documentation | 2 of 3 Multisig Wallet Guide
description: Do you need to setup a multisig wallet on the Loki or Monero Blockchain? Here is a guide provided by Loki Network to get you setup with a 2 of 3 Multisignature Wallet.

...
* `DNS_PUBLIC=tcp` or `DNS_PUBLIC=tcp://x.x.x.x` where x.x.x.x is the IP of the
  ...
  servers defined in [src/common/dns_utils.cpp](https://github.com/loki-project/loki/blob/master/src/common/dns_utils.cpp).
...
* Do NOT pass `--detach` when running through torsocks with systemd, (see
  [utils/systemd/lokid.service](https://github.com/loki-project/loki/blob/master/utils/systemd/monerod.service) for details).

...
`wget https://github.com/loki-project/loki/releases/download/v0.3.8-beta/loki-linux-x64-v0.3.8-beta.zip`
...
`unzip loki-linux-x64-v0.3.8-beta.zip`
...
If not, sometimes unzip will dump the binaries in a folder. In our case the folder would be called `loki-linux-x64-0.3.8-beta`, so to get into it we can type:

`cd loki-linux-x64-v0.3.8-beta`
